...
| Remote Desktop console Winlogon / pre-logon (empty session → logon UI) | `api/05-remote-desktop.md`, `cloud/REMOTE_DESKTOP_WINLOGON.md` | client **≥ 4.9.21** / contract **1.4.21** |
