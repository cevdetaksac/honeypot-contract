...
| Remote Desktop console Winlogon / pre-logon (empty session → logon UI) | `api/05-remote-desktop.md`, `cloud/REMOTE_DESKTOP_WINLOGON.md` | wire ≥ **4.9.21** / contract **1.4.21**; **non-black capture** target ≥ **4.9.26** / contract **1.4.22** (cloud C-WL shipped; 4.9.25 lab = `gdi+black`) |
